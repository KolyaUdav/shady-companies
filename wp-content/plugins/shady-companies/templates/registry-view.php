<?php
     ...
     * @var string $resetUrl - url для сброса фильтра
     */
?>

<div class="shady-companies-registry" style="font-family: system-ui, sans-serif;">  
    <form method="GET" class="registry-filter-form" style="margin-bottom: 30px; display: flex; gap: 10px;">
        <input type="text" name="c_search" value="<?php echo esc_attr($searchValue); ?>" placeholder="Поиск компании..." style="padding: 10px; flex-grow: 1;">
        ...
        <?php if ($searchValue || $tagValue): ?>
            <a href="<?php echo $resetUrl; ?>" style="padding: 10px; align-self: center;">✕ Сбросить</a>
        <?php endif; ?>
    </form>
